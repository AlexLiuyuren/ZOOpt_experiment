from objective_function.objective_function import ackley_noise_log, get_all_epoch, get_epoch_cnt, clear_noisy_global
...
if __name__ == '__main__':
    ...
    for i in range(repeat):
        sol = minimize_ackley_continuous_noisy()
    all_epoch = np.array(get_all_epoch())
    np.savetxt('CMAES_exp/log/ackley_noisy.txt', all_epoch)
