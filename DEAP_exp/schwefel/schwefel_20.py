...
import numpy as np
from objective_function.ordinary_function import schwefel_log, get_all_epoch, set_epoch_len, clear_noisy_global
...
def minimize_schwefel_continuous():
    ...
    toolbox.register("evaluate", lambda x: (schwefel_log(x), ))
    fmin=[]
    population = 10
...
if __name__ == '__main__':
    ...
    np.savetxt('DEAP_exp/log/schwefel/schwefel_20.txt', all_epoch)
