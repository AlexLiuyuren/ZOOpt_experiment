...
import numpy as np
from objective_function.ordinary_function import rastrigin_log, get_all_epoch, set_epoch_len, clear_noisy_global
...
def minimize_rastrigin_continuous():
    ...
    toolbox.register("evaluate", lambda x: (rastrigin_log(x), ))
    fmin=[]
    population = 10
...
if __name__ == '__main__':
    ...
    np.savetxt('DEAP_exp/log/rastrigin/rastrigin_20.txt', all_epoch)
