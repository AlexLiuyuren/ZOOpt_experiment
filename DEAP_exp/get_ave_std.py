...
if __name__ == '__main__':
    ...
    # result_sphere = get_ave_std('DEAP_exp/log/ackley_high_dim.txt', line)
    # np.savetxt('DEAP_exp/log/ackley_high_dim_ave_std.txt', result_sphere)
    ...
    result_sphere = get_ave_std('DEAP_exp/log/ackley_noisy_without_nh.txt', line)
    np.savetxt('DEAP_exp/log/ackley_high_dim_ave_std.txt', result_sphere)
    result_sphere = get_ave_std('DEAP_exp/log/sphere_high_dim.txt', line)
    np.savetxt('DEAP_exp/log/sphere_high_dim_ave_std.txt', result_sphere)
