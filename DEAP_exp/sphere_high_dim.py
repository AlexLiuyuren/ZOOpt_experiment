...
import numpy as np
from objective_function.high_dim_function import sphere_high_log, get_all_epoch, set_epoch_len, clear_noisy_global
...
def minimize_sphere_continuous():
    ...
    toolbox.register("evaluate", lambda x: (sphere_high_log(x), ))
    fmin=[]
    generation = 20
