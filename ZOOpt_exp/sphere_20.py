from objective_function.ordinary_function import sphere_log, clear_noisy_global, get_all_epoch, get_epoch_cnt
...
if __name__ == '__main__':
    ...
    for i in range(repeat_num):
        ...
        objective = Objective(lambda sol: sphere_log(sol.get_x()), dim)  # form up the objective function
    ...
    np.savetxt('ZOOpt_exp/log/sphere_20.txt', all_epoch)
