from objective_function.high_dim_function import sphere_high_log, clear_noisy_global, get_all_epoch, get_epoch_cnt
...
if __name__ == '__main__':
    ...
    set_optimal_position(
        "/Users/liu/Desktop/CS/ZOOpt_exp/ZOOpt_experiment/objective_function/optimal_position/sphere/sphere_10000.txt")
    gl.set_seed(666)
    for i in range(repeat_num):
        ...
        objective = Objective(lambda sol: sphere_high_log(sol.get_x()), dim)  # form up the objective function
    ...
    np.savetxt('ZOOpt_exp/log/sphere_10000_sre.txt', all_epoch)
