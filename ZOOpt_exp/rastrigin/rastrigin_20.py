from objective_function.ordinary_function import rastrigin_log, clear_noisy_global, get_all_epoch, get_epoch_cnt, set_epoch_len
...
if __name__ == '__main__':
    ...
    set_optimal_position(
        "/Users/liu/Desktop/CS/ZOOpt_exp/ZOOpt_experiment/objective_function/optimal_position/rastrigin/rastrigin_20.txt")
    gl.set_seed(666)
    budget = 10000
    ...
    for i in range(repeat_num):
        ...
        objective = Objective(lambda sol: rastrigin_log(sol.get_x()), dim)  # form up the objective function
    ...
    np.savetxt('ZOOpt_exp/log/rastrigin/rastrigin_20.txt', all_epoch)
