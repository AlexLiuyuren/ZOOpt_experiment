from objective_function.ordinary_function import ackley_log, clear_noisy_global, get_all_epoch, get_epoch_cnt, set_epoch_len
...
if __name__ == '__main__':
    ...
    set_optimal_position(
        "/Users/liu/Desktop/CS/ZOOpt_exp/ZOOpt_experiment/objective_function/optimal_position/ackley/ackley_20.txt")
    gl.set_seed(666)
    set_epoch_len(2000)
    for i in range(repeat_num):
        ...
        objective = Objective(lambda sol: ackley_log(sol.get_x()), dim)  # form up the objective function
