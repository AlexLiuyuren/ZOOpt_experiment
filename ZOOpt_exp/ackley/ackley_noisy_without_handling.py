...
if __name__ == '__main__':
    ...
    set_optimal_position(
        "/Users/liu/Desktop/CS/ZOOpt_exp/ZOOpt_experiment/objective_function/optimal_position/ackley/ackley_100.txt")
    gl.set_seed(666)
    for i in range(repeat_num):
        ...
        objective = Objective(ackley_noise_zoopt, dim)  # form up the objective function
    ...
    np.savetxt('ZOOpt_exp/log/ackley_noisy_without_handling.txt', all_epoch)
