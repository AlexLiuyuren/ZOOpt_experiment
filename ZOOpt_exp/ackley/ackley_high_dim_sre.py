...
if __name__ == '__main__':
    ...
    set_optimal_position(
        "/Users/liu/Desktop/CS/ZOOpt_exp/ZOOpt_experiment/objective_function/optimal_position/ackley/ackley_10000.txt")
    gl.set_seed(666)
    ...
    np.savetxt('ZOOpt_exp/log/ackley_10000_sre.txt', all_epoch)
